...
> **Part of the JEPA Series** | [← Previous: 04 JEPA for Perturb-seq](04_jepa_perturbseq.md) | [Series Index](README.md)  
> **Status**: Graduated from incubation → Active JEPA documentation  
> **Original**: [docs/incubation/joint_latent_space_and_JEPA.md](../incubation/joint_latent_space_and_JEPA.md)
