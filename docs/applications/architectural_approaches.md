# Generative AI for Perturbation Modeling: Architectural Approaches

> **Status**: Graduated from incubation → Active application  
> **Related**: [perturbation_prediction.md](perturbation_prediction.md) — Implementation roadmap  
> **Original**: [docs/incubation/generative-ai-for-perturbation-modeling.md](../incubation/generative-ai-for-perturbation-modeling.md)

This document explores various architectural approaches for perturbation modeling, analyzing the trade-offs between predictive and generative methods. It provides the theoretical foundation for the [Perturbation Prediction application](perturbation_prediction.md).
